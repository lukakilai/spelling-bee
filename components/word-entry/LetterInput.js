...
export default function LetterInput({
  ...
  return (
    <input
      ...
      id={index}
      maxLength={1}
      className={`border bg-stone-50 w-[45px] aspect-square rounded-md text-center text-xl focus:outline focus:outline-offset-0 focus:outline-sky-400 disabled:opacity-40
                  ${
                    isDirty &&
